...
public class PreviousCommand extends Command {
    ...
    public PreviousCommand(Module module, BotInstance root) {
        super(module, root);
    }
    ...
    public void exec(String userName, String id, UserLevel userLevel, String[] args) {
        ModuleEntry sPause = getModule().getEntry("sPrevious");
        ...
        getRoot().getSpotifyApi().skipUsersPlaybackToPreviousTrack().build().execute();
